...
function Dashboard() {
    return (
        ...
        <Sidebar/>
            ...
            <div className="row">
                <Card title="Earnings(Monthly)" value="Rs.40,000" color="primary" />
                <Card title="Earnings(Annual)" value="Rs.215,000" color="success" />
                <Card title="Products" value="50%" color="info" />
